 ...
 */
const t="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,e=(t,e,s=null)=>{for(;e!==s;){const s=e.nextSibling;t.removeChild(e),e=s}},s=`{{lit-${String(Math.random()).slice(2)}}}`,r=`\x3c!--${s}--\x3e`,o=new RegExp(`${s}|${r}`),i="$lit$";class a{constructor(t,e){this.parts=[],this.element=e;const r=[],a=[],l=document.createTreeWalker(e.content,133,null,!1);let p=0,h=-1,u=0;const{strings:g,values:{length:v}}=t;for(;u<v;){const t=l.nextNode();if(null!==t){if(h++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:s}=e;let r=0;for(let t=0;t<s;t++)n(e[t].name,i)&&r++;for(;r-- >0;){const e=g[u],s=d.exec(e)[2],r=s.toLowerCase()+i,a=t.getAttribute(r);t.removeAttribute(r);const n=a.split(o);this.parts.push({type:"attribute",index:h,name:s,strings:n}),u+=n.length-1}}"TEMPLATE"===t.tagName&&(a.push(t),l.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(s)>=0){const s=t.parentNode,a=e.split(o),l=a.length-1;for(let e=0;e<l;e++){let r,o=a[e];if(""===o)r=c();else{const t=d.exec(o);null!==t&&n(t[2],i)&&(o=o.slice(0,t.index)+t[1]+t[2].slice(0,-5)+t[3]),r=document.createTextNode(o)}s.insertBefore(r,t),this.parts.push({type:"node",index:++h})}""===a[l]?(s.insertBefore(c(),t),r.push(t)):t.data=a[l],u+=l}}else if(8===t.nodeType)if(t.data===s){const e=t.parentNode;null!==t.previousSibling&&h!==p||(h++,e.insertBefore(c(),t)),p=h,this.parts.push({type:"node",index:h}),null===t.nextSibling?t.data="":(r.push(t),h--),u++}else{let e=-1;for(;-1!==(e=t.data.indexOf(s,e+1));)this.parts.push({type:"node",index:-1}),u++}}else l.currentNode=a.pop()}for(const t of r)t.parentNode.removeChild(t)}}const n=(t,e)=>{const s=t.length-e.length;return s>=0&&t.slice(s)===e},l=t=>-1!==t.index,c=()=>document.createComment(""),d=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function p(t,e){const{element:{content:s},parts:r}=t,o=document.createTreeWalker(s,133,null,!1);let i=u(r),a=r[i],n=-1,l=0;const c=[];let d=null;for(;o.nextNode();){n++;const t=o.currentNode;for(t.previousSibling===d&&(d=null),e.has(t)&&(c.push(t),null===d&&(d=t)),null!==d&&l++;void 0!==a&&a.index===n;)a.index=null!==d?-1:a.index-l,i=u(r,i),a=r[i]}c.forEach((t=>t.parentNode.removeChild(t)))}const h=t=>{let e=11===t.nodeType?0:1;const s=document.createTreeWalker(t,133,null,!1);for(;s.nextNode();)e++;return e},u=(t,e=-1)=>{for(let s=e+1;s<t.length;s++){const e=t[s];if(l(e))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class b{constructor(t,e,s){this.__parts=[],this.template=t,this.processor=e,this.options=s}update(t){let e=0;for(const s of this.__parts)void 0!==s&&s.setValue(t[e]),e++;for(const t of this.__parts)void 0!==t&&t.commit()}_clone(){const e=t?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),s=[],r=this.template.parts,o=document.createTreeWalker(e,133,null,!1);let i,a=0,n=0,c=o.nextNode();for(;a<r.length;)if(i=r[a],l(i)){for(;n<i.index;)n++,"TEMPLATE"===c.nodeName&&(s.push(c),o.currentNode=c.content),null===(c=o.nextNode())&&(o.currentNode=s.pop(),c=o.nextNode());if("node"===i.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(c.previousSibling),this.__parts.push(t)}else this.__parts.push(...this.processor.handleAttributeExpressions(c,i.name,i.strings,this.options));a++}else this.__parts.push(void 0),a++;return t&&(document.adoptNode(e),customElements.upgrade(e)),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const _=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),y=` ${s} `;class x{constructor(t,e,s,r){this.strings=t,this.values=e,this.type=s,this.processor=r}getHTML(){const t=this.strings.length-1;let e="",o=!1;for(let a=0;a<t;a++){const t=this.strings[a],n=t.lastIndexOf("\x3c!--");o=(n>-1||o)&&-1===t.indexOf("--\x3e",n+1);const l=d.exec(t);e+=null===l?t+(o?y:r):t.substr(0,l.index)+l[1]+l[2]+i+l[3]+s}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");let e=this.getHTML();return void 0!==_&&(e=_.createHTML(e)),t.innerHTML=e,t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */;function V(t){let e=U.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},U.set(t.type,e));let r=e.stringsArray.get(t.strings);if(void 0!==r)return r;const o=t.strings.join(s);return r=e.keyString.get(o),void 0===r&&(r=new a(t,t.getTemplateElement()),e.keyString.set(o,r)),e.stringsArray.set(t.strings,r),r}const U=new Map,M=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class{handleAttributeExpressions(t,e,s,r){const o=e[0];if("."===o){return new $(t,e.slice(1),s).parts}if("@"===o)return[new A(t,e.slice(1),r.eventContext)];if("?"===o)return[new k(t,e.slice(1),s)];return new C(t,e,s).parts}handleTextExpression(t){return new N(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */,z=(t,e)=>`${t}--${e}`;let L=!0;void 0===window.ShadyCSS?L=!1:void 0===window.ShadyCSS.prepareTemplateDom&&(console.warn("Incompatible ShadyCSS version detected. Please update to at least @webcomponents/webcomponentsjs@2.0.2 and @webcomponents/shadycss@1.3.1."),L=!1);const q=t=>e=>{const r=z(e.type,t);let o=U.get(r);void 0===o&&(o={stringsArray:new WeakMap,keyString:new Map},U.set(r,o));let i=o.stringsArray.get(e.strings);if(void 0!==i)return i;const n=e.strings.join(s);if(i=o.keyString.get(n),void 0===i){const s=e.getTemplateElement();L&&window.ShadyCSS.prepareTemplateDom(s,t),i=new a(e,s),o.keyString.set(n,i)}return o.stringsArray.set(e.strings,i),i},I=["html","svg"],B=new Set,F=(t,e,s)=>{B.add(t);const r=s?s.element:document.createElement("template"),o=e.querySelectorAll("style"),{length:i}=o;if(0===i)return void window.ShadyCSS.prepareTemplateStyles(r,t);const a=document.createElement("style");for(let t=0;t<i;t++){const e=o[t];e.parentNode.removeChild(e),a.textContent+=e.textContent}(t=>{I.forEach((e=>{const s=U.get(z(e,t));void 0!==s&&s.keyString.forEach((t=>{const{element:{content:e}}=t,s=new Set;Array.from(e.querySelectorAll("style")).forEach((t=>{s.add(t)})),p(t,s)}))}))})(t);const n=r.content;s?function(t,e,s=null){const{element:{content:r},parts:o}=t;if(null==s)return void r.appendChild(e);const i=document.createTreeWalker(r,133,null,!1);let a=u(o),n=0,l=-1;for(;i.nextNode();)for(l++,i.currentNode===s&&(n=h(e),s.parentNode.insertBefore(e,s));-1!==a&&o[a].index===l;){if(n>0){for(;-1!==a;)o[a].index+=n,a=u(o,a);return}a=u(o,a)}}(s,a,n.firstChild):n.insertBefore(a,n.firstChild),window.ShadyCSS.prepareTemplateStyles(r,t);const l=n.querySelector("style");if(window.ShadyCSS.nativeShadow&&null!==l)e.insertBefore(l.cloneNode(!0),e.firstChild);else if(s){n.insertBefore(a,n.firstChild);const t=new Set;t.add(a),p(s,t)}};window.JSCompiler_renameProperty=(t,e)=>t;const H={toAttribute(t,e){switch(e){case Boolean:return t?"":null;case Object:case Array:return null==t?t:JSON.stringify(t)}return t},fromAttribute(t,e){switch(e){case Boolean:return null!==t;case Number:return null===t?null:Number(t);case Object:case Array:return JSON.parse(t)}return t}},D=(t,e)=>e!==t&&(e==e||t==t),G={attribute:!0,type:String,converter:H,reflect:!1,hasChanged:D},W="finalized";class J extends HTMLElement{constructor(){super(),this.initialize()}static get observedAttributes(){this.finalize();const t=[];return this._classProperties.forEach(((e,s)=>{const r=this._attributeNameForProperty(s,e);void 0!==r&&(this._attributeToPropertyMap.set(r,s),t.push(r))})),t}static _ensureClassProperties(){if(!this.hasOwnProperty(JSCompiler_renameProperty("_classProperties",this))){this._classProperties=new Map;const t=Object.getPrototypeOf(this)._classProperties;void 0!==t&&t.forEach(((t,e)=>this._classProperties.set(e,t)))}}static createProperty(t,e=G){if(this._ensureClassProperties(),this._classProperties.set(t,e),e.noAccessor||this.prototype.hasOwnProperty(t))return;const s="symbol"==typeof t?Symbol():`__${t}`,r=this.getPropertyDescriptor(t,s,e);void 0!==r&&Object.defineProperty(this.prototype,t,r)}static getPropertyDescriptor(t,e,s){return{get(){return this[e]},set(r){const o=this[t];this[e]=r,this.requestUpdateInternal(t,o,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(t){return this._classProperties&&this._classProperties.get(t)||G}static finalize(){const t=Object.getPrototypeOf(this);if(t.hasOwnProperty(W)||t.finalize(),this[W]=!0,this._ensureClassProperties(),this._attributeToPropertyMap=new Map,this.hasOwnProperty(JSCompiler_renameProperty("properties",this))){const t=this.properties,e=[...Object.getOwnPropertyNames(t),..."function"==typeof Object.getOwnPropertySymbols?Object.getOwnPropertySymbols(t):[]];for(const s of e)this.createProperty(s,t[s])}}static _attributeNameForProperty(t,e){const s=e.attribute;return!1===s?void 0:"string"==typeof s?s:"string"==typeof t?t.toLowerCase():void 0}static _valueHasChanged(t,e,s=D){return s(t,e)}static _propertyValueFromAttribute(t,e){const s=e.type,r=e.converter||H,o="function"==typeof r?r:r.fromAttribute;return o?o(t,s):t}static _propertyValueToAttribute(t,e){if(void 0===e.reflect)return;const s=e.type,r=e.converter;return(r&&r.toAttribute||H.toAttribute)(t,s)}initialize(){this._updateState=0,this._updatePromise=new Promise((t=>this._enableUpdatingResolver=t)),this._changedProperties=new Map,this._saveInstanceProperties(),this.requestUpdateInternal()}_saveInstanceProperties(){this.constructor._classProperties.forEach(((t,e)=>{if(this.hasOwnProperty(e)){const t=this[e];delete this[e],this._instanceProperties||(this._instanceProperties=new Map),this._instanceProperties.set(e,t)}}))}_applyInstanceProperties(){this._instanceProperties.forEach(((t,e)=>this[e]=t)),this._instanceProperties=void 0}connectedCallback(){this.enableUpdating()}enableUpdating(){void 0!==this._enableUpdatingResolver&&(this._enableUpdatingResolver(),this._enableUpdatingResolver=void 0)}disconnectedCallback(){}attributeChangedCallback(t,e,s){e!==s&&this._attributeToProperty(t,s)}_propertyToAttribute(t,e,s=G){const r=this.constructor,o=r._attributeNameForProperty(t,s);if(void 0!==o){const t=r._propertyValueToAttribute(e,s);if(void 0===t)return;this._updateState=8|this._updateState,null==t?this.removeAttribute(o):this.setAttribute(o,t),this._updateState=-9&this._updateState}}_attributeToProperty(t,e){if(8&this._updateState)return;const s=this.constructor,r=s._attributeToPropertyMap.get(t);if(void 0!==r){const t=s.getPropertyOptions(r);this._updateState=16|this._updateState,this[r]=s._propertyValueFromAttribute(e,t),this._updateState=-17&this._updateState}}requestUpdateInternal(t,e,s){let r=!0;if(void 0!==t){const o=this.constructor;s=s||o.getPropertyOptions(t),o._valueHasChanged(this[t],e,s.hasChanged)?(this._changedProperties.has(t)||this._changedProperties.set(t,e),!0!==s.reflect||16&this._updateState||(void 0===this._reflectingProperties&&(this._reflectingProperties=new Map),this._reflectingProperties.set(t,s))):r=!1}!this._hasRequestedUpdate&&r&&(this._updatePromise=this._enqueueUpdate())}requestUpdate(t,e){return this.requestUpdateInternal(t,e),this.updateComplete}async _enqueueUpdate(){this._updateState=4|this._updateState;try{await this._updatePromise}catch(t){}const t=this.performUpdate();return null!=t&&await t,!this._hasRequestedUpdate}get _hasRequestedUpdate(){return 4&this._updateState}get hasUpdated(){return 1&this._updateState}performUpdate(){if(!this._hasRequestedUpdate)return;this._instanceProperties&&this._applyInstanceProperties();let t=!1;const e=this._changedProperties;try{t=this.shouldUpdate(e),t?this.update(e):this._markUpdated()}catch(e){throw t=!1,this._markUpdated(),e}t&&(1&this._updateState||(this._updateState=1|this._updateState,this.firstUpdated(e)),this.updated(e))}_markUpdated(){this._changedProperties=new Map,this._updateState=-5&this._updateState}get updateComplete(){return this._getUpdateComplete()}_getUpdateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._updatePromise}shouldUpdate(t){return!0}update(t){void 0!==this._reflectingProperties&&this._reflectingProperties.size>0&&(this._reflectingProperties.forEach(((t,e)=>this._propertyToAttribute(e,this[e],t))),this._reflectingProperties=void 0),this._markUpdated()}updated(t){}firstUpdated(t){}}J[W]=!0;
/**
@license
...
`,st={chlorine:{name:"Chlorine",unit:"ppm",min:0,max:10,setpoint:3,decimals:1,gradient:"chlorine"},ph:{name:"pH",unit:"",min:6,max:9,setpoint:7.5,decimals:1,gradient:"ph"},salt:{name:"Salt",unit:"ppm",min:1e3,max:3e3,setpoint:1750,decimals:0,gradient:"salt"},iq_sensor:{name:"IQ Sensor",unit:"hours",min:0,max:1e4,setpoint:5e3,decimals:0,gradient:"iq-sensor",display_format:"hours_to_months"}};const rt=Object.keys(st);customElements.define("spa-monitor-card-editor",class extends tt{static get properties(){return{hass:{type:Object},_config:{type:Object}}}static get styles(){return X`
      .editor {
        display: flex;
        flex-direction: column;
        gap: 16px;
    ...
    `}_titleChanged(t){this._updateConfig({title:t.target.value})}_themeChanged(t){this._updateConfig({theme:t.target.value})}_sensorChanged(t,e){const s=e.detail.value,r={...this._config.sensors};s?r[t]={...r[t]||{},entity:s}:delete r[t],this._updateConfig({sensors:r})}_controlChanged(t,e){const s=e.detail.value,r={...this._config.controls};s?r[t]={...r[t]||{},entity:s}:delete r[t],this._updateConfig({controls:r})}_updateConfig(t){this._config={...this._config,...t},function(t,e,s){const r=new CustomEvent(e,{bubbles:!0,composed:!0,detail:s});t.dispatchEvent(r)}(this,"config-changed",{config:this._config})}});const ot=["auto","light","dark","glass"];let it=0;console.info("%c SPA-MONITOR-CARD %c v0.1.0 ","color: white; background: #16a34a; font-weight: bold;","color: #16a34a; background: white; font-weight: bold;");customElements.define("spa-monitor-card",class extends tt{constructor(){super(),this._instanceId=it++}static get properties(){return{hass:{type:Object},_config:{type:Object}}}static get styles(){return et}static getConfigElement(){return document.createElement("spa-monitor-card-editor")}setConfig(t){if(!t.sensors||0===Object.keys(t.sensors).length)throw new Error("Please define at least one sensor.");if(t.theme&&!ot.includes(t.theme))throw new Error(`Invalid theme "${t.theme}". Must be: ${ot.join(", ")}`);const e={};for(const[s,r]of Object.entries(t.sensors)){const t=st[s]||{};if(e[s]={...t,...r,gradient:r.gradient||t.gradient||"chlorine"},!e[s].entity)throw new Error(`Sensor "${s}" requires an entity.`)}this._config={...t,title:t.title||"",theme:t.theme||"auto",sensors:e,controls:t.controls||{}}}getConfig(){return this._config}getCardSize(){return 4}render(){if(!this._config||!this.hass)return j``;const t=this._config.theme,e="dark"===t||"auto"===t&&this.hass.themes?.darkMode;return j`
    ...
    `}_renderSingleGauge(t,e){const s=this.hass.states[e.entity],r=this._isUnavailable(s),o=r?null:parseFloat(s.state),i=`gradient-${e.gradient||"standard"}`,a=r?0:function(t,e,s){return(Math.max(e,Math.min(s,t))-e)/(s-e)*100}(o,e.min,e.max);let n="---";return r||(n=this._formatValue(o,e)),j`
      <div class="gauge ${r?"unavailable":""}">
        <span class="gauge-label">${e.name}</span>
        <div class="gauge-bar-container">
          <div class="gauge-bar ${i}"></div>
          ${r?"":j`
    ...
    `}_renderOutputLevel(){const t=this._config.controls.output_level.entity,e=this.hass.states[t],s=this._isUnavailable(e),r=s?0:parseFloat(e.state),o=e?.attributes?.min??0,i=e?.attributes?.max??10;return j`
      <div class="output-level-wrapper ${s?"unavailable":""}">
        <span class="output-level-label">Output Level</span>
        <div class="output-level">
          <button class="stepper-btn"
            ?disabled=${s}
            @click=${()=>this._setOutputLevel(Math.max(o,r-1))}>
            −
          </button>
          <span class="output-level-value">${s?"---":r}</span>
          <button class="stepper-btn"
            ?disabled=${s}
            @click=${()=>this._setOutputLevel(Math.min(i,r+1))}>
            +
          </button>
        </div>
      </div>
