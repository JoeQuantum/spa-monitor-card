 ...
 */
const t="undefined"!=typeof window&&null!=window.customElements&&void 0!==window.customElements.polyfillWrapFlushCallback,e=(t,e,s=null)=>{for(;e!==s;){const s=e.nextSibling;t.removeChild(e),e=s}},s=`{{lit-${String(Math.random()).slice(2)}}}`,r=`\x3c!--${s}--\x3e`,i=new RegExp(`${s}|${r}`),o="$lit$";class a{constructor(t,e){this.parts=[],this.element=e;const r=[],a=[],l=document.createTreeWalker(e.content,133,null,!1);let p=0,h=-1,u=0;const{strings:g,values:{length:v}}=t;for(;u<v;){const t=l.nextNode();if(null!==t){if(h++,1===t.nodeType){if(t.hasAttributes()){const e=t.attributes,{length:s}=e;let r=0;for(let t=0;t<s;t++)n(e[t].name,o)&&r++;for(;r-- >0;){const e=g[u],s=c.exec(e)[2],r=s.toLowerCase()+o,a=t.getAttribute(r);t.removeAttribute(r);const n=a.split(i);this.parts.push({type:"attribute",index:h,name:s,strings:n}),u+=n.length-1}}"TEMPLATE"===t.tagName&&(a.push(t),l.currentNode=t.content)}else if(3===t.nodeType){const e=t.data;if(e.indexOf(s)>=0){const s=t.parentNode,a=e.split(i),l=a.length-1;for(let e=0;e<l;e++){let r,i=a[e];if(""===i)r=d();else{const t=c.exec(i);null!==t&&n(t[2],o)&&(i=i.slice(0,t.index)+t[1]+t[2].slice(0,-5)+t[3]),r=document.createTextNode(i)}s.insertBefore(r,t),this.parts.push({type:"node",index:++h})}""===a[l]?(s.insertBefore(d(),t),r.push(t)):t.data=a[l],u+=l}}else if(8===t.nodeType)if(t.data===s){const e=t.parentNode;null!==t.previousSibling&&h!==p||(h++,e.insertBefore(d(),t)),p=h,this.parts.push({type:"node",index:h}),null===t.nextSibling?t.data="":(r.push(t),h--),u++}else{let e=-1;for(;-1!==(e=t.data.indexOf(s,e+1));)this.parts.push({type:"node",index:-1}),u++}}else l.currentNode=a.pop()}for(const t of r)t.parentNode.removeChild(t)}}const n=(t,e)=>{const s=t.length-e.length;return s>=0&&t.slice(s)===e},l=t=>-1!==t.index,d=()=>document.createComment(""),c=/([ \x09\x0a\x0c\x0d])([^\0-\x1F\x7F-\x9F "'>=/]+)([ \x09\x0a\x0c\x0d]*=[ \x09\x0a\x0c\x0d]*(?:[^ \x09\x0a\x0c\x0d"'`<>=]*|"[^"]*|'[^']*))$/;function p(t,e){const{element:{content:s},parts:r}=t,i=document.createTreeWalker(s,133,null,!1);let o=u(r),a=r[o],n=-1,l=0;const d=[];let c=null;for(;i.nextNode();){n++;const t=i.currentNode;for(t.previousSibling===c&&(c=null),e.has(t)&&(d.push(t),null===c&&(c=t)),null!==c&&l++;void 0!==a&&a.index===n;)a.index=null!==c?-1:a.index-l,o=u(r,o),a=r[o]}d.forEach((t=>t.parentNode.removeChild(t)))}const h=t=>{let e=11===t.nodeType?0:1;const s=document.createTreeWalker(t,133,null,!1);for(;s.nextNode();)e++;return e},u=(t,e=-1)=>{for(let s=e+1;s<t.length;s++){const e=t[s];if(l(e))return s}return-1};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
class b{constructor(t,e,s){this.__parts=[],this.template=t,this.processor=e,this.options=s}update(t){let e=0;for(const s of this.__parts)void 0!==s&&s.setValue(t[e]),e++;for(const t of this.__parts)void 0!==t&&t.commit()}_clone(){const e=t?this.template.element.content.cloneNode(!0):document.importNode(this.template.element.content,!0),s=[],r=this.template.parts,i=document.createTreeWalker(e,133,null,!1);let o,a=0,n=0,d=i.nextNode();for(;a<r.length;)if(o=r[a],l(o)){for(;n<o.index;)n++,"TEMPLATE"===d.nodeName&&(s.push(d),i.currentNode=d.content),null===(d=i.nextNode())&&(i.currentNode=s.pop(),d=i.nextNode());if("node"===o.type){const t=this.processor.handleTextExpression(this.options);t.insertAfterNode(d.previousSibling),this.__parts.push(t)}else this.__parts.push(...this.processor.handleAttributeExpressions(d,o.name,o.strings,this.options));a++}else this.__parts.push(void 0),a++;return t&&(document.adoptNode(e),customElements.upgrade(e)),e}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const _=window.trustedTypes&&trustedTypes.createPolicy("lit-html",{createHTML:t=>t}),y=` ${s} `;class x{constructor(t,e,s,r){this.strings=t,this.values=e,this.type=s,this.processor=r}getHTML(){const t=this.strings.length-1;let e="",i=!1;for(let a=0;a<t;a++){const t=this.strings[a],n=t.lastIndexOf("\x3c!--");i=(n>-1||i)&&-1===t.indexOf("--\x3e",n+1);const l=c.exec(t);e+=null===l?t+(i?y:r):t.substr(0,l.index)+l[1]+l[2]+o+l[3]+s}return e+=this.strings[t],e}getTemplateElement(){const t=document.createElement("template");let e=this.getHTML();return void 0!==_&&(e=_.createHTML(e)),t.innerHTML=e,t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`,st={chlorine:{name:"Chlorine",unit:"ppm",min:0,max:6,setpoint:3,decimals:1,gradient:"standard"},ph:{name:"pH",unit:"",min:7,max:8,setpoint:7.5,decimals:1,gradient:"standard"},salt:{name:"Salt",unit:"ppm",min:1200,max:2400,setpoint:1800,decimals:0,gradient:"standard"},iq_sensor:{name:"IQ Sensor",unit:"",min:0,max:1e4,setpoint:5e3,decimals:0,gradient:"depletion",display_format:"hours_to_months"}};const rt=Object.keys(st);customElements.define("spa-monitor-card-editor",class extends tt{static get properties(){return{hass:{type:Object},_config:{type:Object}}}static get styles(){return X`
    ...
    `}_renderSingleGauge(t,e){const s=this.hass.states[e.entity],r=this._isUnavailable(s),i=r?null:parseFloat(s.state),o=`gradient-${e.gradient||"standard"}`,a=r?0:function(t,e,s){return(Math.max(e,Math.min(s,t))-e)/(s-e)*100}(i,e.min,e.max);let n="---";return r||(n=this._formatValue(i,e)),j`
